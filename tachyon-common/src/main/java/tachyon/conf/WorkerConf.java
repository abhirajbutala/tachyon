...
import tachyon.worker.EvictStrategyType;
import tachyon.worker.AllocateStrategyType;
import tachyon.worker.ChannelType;
import tachyon.worker.FileTransferType;
