...
4.  Read and understand [an example](https://github.com/amplab/tachyon/blob/master/tachyon-clients/tachyon-examples/src/main/java/tachyon/examples/BasicOperations.java).
